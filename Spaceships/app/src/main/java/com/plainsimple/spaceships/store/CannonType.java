...
public enum CannonType {
    ...
    CANNON_0(BitmapID.CANNONS_0, BitmapID.BULLET_0, 10, 12, 0.01f),
    CANNON_1(BitmapID.CANNONS_1, BitmapID.BULLET_1, 20, 10, 0.011f),
    CANNON_2(BitmapID.CANNONS_2, BitmapID.BULLET_2, 30, 8, 0.012f), // todo: graphics
    CANNON_3(BitmapID.CANNONS_3, BitmapID.BULLET_3, 40, 18, 0.013f);
